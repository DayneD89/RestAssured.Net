...
namespace RA.Enums
{
    public class LoadValueTypes : Enumeration<LoadValueTypes, string>
    {
        ...
        public static LoadValueTypes PercentSucceeded = new LoadValueTypes("Percent-Succeeded", "Percent Succeeded");
        public static LoadValueTypes PercentLost = new LoadValueTypes("Percent-Lost", "Percent Lost");
